...
begin
    ...
    $fdisplay(summary_file, "Taken Jumps              : %0d", jump_taken_count);
    ...
    $display("Stalls=%0d | Branches Taken=%0d | Jumps Taken=%0d | Forwards=%0d",
             stall_count, branch_taken_count, jump_taken_count, total_forward_count);
end
endtask
